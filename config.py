...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6589551297"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002186342338"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6589551297, 6686798585").split()):
        ADMINS.append(int(x))
except ValueError:
